...
reasons = { 1 : True,
            4 : True,
            5 : False,
            8 : True } # True when client STA should be sender of deauth
...
def main(args):
    ...
    # Send the desired number of packets with givent interval
    sendp(packet, iface=args.interface, inter=args.interval, count=args.count, verbose=True)



if __name__ == "__main__":
    # Argument parsing, nothing interesting here...
