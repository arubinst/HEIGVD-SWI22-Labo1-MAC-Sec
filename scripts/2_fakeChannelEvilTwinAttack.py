...
if __name__ == "__main__":
    ...
    # start the channel changer in a new thread
    endChange = 0
    ...
    attackSSIDChannel = networks.at[bsidToAttack, "Channel"]
    print("Was on Channel: ", attackSSIDChannel)
    
    # Twin is separated by 6 channels from the target
    newChannel = (int(attackSSIDChannel) + 5) % 13 + 1
    print("Clone on Channel: ", newChannel)
    # Configure the channel on the interface
